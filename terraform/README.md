...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_tempo_compactor"></a> [tempo\_compactor](#module\_tempo\_compactor) | ../worker/terraform | n/a |
| <a name="module_tempo_coordinator"></a> [tempo\_coordinator](#module\_tempo\_coordinator) | ../coordinator/terraform | n/a |
| <a name="module_tempo_distributor"></a> [tempo\_distributor](#module\_tempo\_distributor) | ../worker/terraform | n/a |
| <a name="module_tempo_ingester"></a> [tempo\_ingester](#module\_tempo\_ingester) | ../worker/terraform | n/a |
| <a name="module_tempo_metrics_generator"></a> [tempo\_metrics\_generator](#module\_tempo\_metrics\_generator) | ../worker/terraform | n/a |
| <a name="module_tempo_querier"></a> [tempo\_querier](#module\_tempo\_querier) | ../worker/terraform | n/a |
| <a name="module_tempo_query_frontend"></a> [tempo\_query\_frontend](#module\_tempo\_query\_frontend) | ../worker/terraform | n/a |
...
| <a name="input_metrics_generator_worker_storage_directives"></a> [metrics\_generator\_worker\_storage\_directives](#input\_metrics\_generator\_worker\_storage\_directives) | Map of storage used by the metrics-generator worker application, which defaults to 1 GB, allocated by Juju | `map(string)` | `{}` | no |
