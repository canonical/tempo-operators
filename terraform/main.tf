...
module "tempo_querier" {
  ...
  storage_directives = var.querier_storage_directives
...
module "tempo_query_frontend" {
  ...
  revision           = var.worker_revision
  storage_directives = var.query_frontend_storage_directives
...
module "tempo_ingester" {
  ...
  revision           = var.worker_revision
  storage_directives = var.ingester_storage_directives
...
module "tempo_distributor" {
  ...
  revision           = var.worker_revision
  storage_directives = var.distributor_storage_directives
...
module "tempo_compactor" {
  ...
  revision           = var.worker_revision
  storage_directives = var.compactor_storage_directives
...
module "tempo_metrics_generator" {
  ...
  revision           = var.worker_revision
  storage_directives = var.metrics_generator_storage_directives
