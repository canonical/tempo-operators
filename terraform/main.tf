...
module "tempo_coordinator" {
  source = "git::https://github.com/canonical/tempo-operators//coordinator/terraform?ref=track/2"
...
module "tempo_querier" {
  source     = "git::https://github.com/canonical/tempo-operators//worker/terraform?ref=track/2"
