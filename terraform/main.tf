...
module "tempo_coordinator" {
  source = "git::https://github.com/canonical/tempo-operators//coordinator/terraform?ref=tf-provider-v0"
...
module "tempo_querier" {
  source     = "git::https://github.com/canonical/tempo-operators//worker/terraform?ref=tf-provider-v0"
